...
@section('content')
    ...
    if(count($incidences) != 0) {
        ...
        <!-- Page Heading -->
        <h2 class="color-deep-blue mb-4"><strong>Incidencias resueltas</strong></h2>
    ...
    if(count($externalIncidences) != 0) {
        ...
        <h2 class="color-deep-blue mb-4"><strong>Incidencias externas resueltas</strong></h2>
    ...
    if(count($serviceIncidences) != 0) {
        ...
        <!-- Page Heading -->
        <h2 class="color-deep-blue mb-4"><strong>Incidencias de servicio resueltas</strong></h2>
